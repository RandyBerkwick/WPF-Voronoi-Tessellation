...
namespace VoronoiNS
{
    public class VoronoiCellEdge
    {
        ...
        public void AddVertex(VoronoiCellVertex vertex)
        {
            ...
            {
                Debug.WriteLine("Impossible: an edge can only have 2 vertices, not 3!", "Error");
                return;
            }
        ...
        */
        public void AddCellWithSideEffects(VoronoiCell c)
        {
            ...
            {
                Debug.WriteLine("Cannot add a third cell to an edge!", "Error");
                return;
            }
            ...
            {
                Debug.WriteLine("Fail: this edge has one or both edgeVertex nodes missing; cannot continue", "Error");
                return;
            }
            else
            {
