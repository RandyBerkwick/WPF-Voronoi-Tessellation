    ...
    public class VoronoiDiagram 
    {
        ...
        */
        public static VoronoiDiagram CreateDiagramFromVoronoiOutput(Voronoi voronoiGenerator, bool useUnity2DCoordsNot3D)
        {
            ...
            Dictionary<Point, VoronoiCellVertex> generatedVertices = new Dictionary<Point, VoronoiCellVertex>();
            ...
            foreach (Edge edge in voronoiGenerator.Edges())
            {
                ...
                Point clippedEndLeft = (Point)edge.clippedEnds[Side.LEFT];
                Point clippedEndRight = (Point)edge.clippedEnds[Side.RIGHT];
        ...
        to maintain identity of Point co-ordinates (unlike Unity, which maintains them
        effectively).
        ...
        Ugh.
        */
        private static VoronoiCellVertex FetchVertexOrAddToObject(Point voronoiSite, Dictionary<Point, VoronoiCellVertex> verticesByPoint, GameObject go, bool useUnity2DCoordsNot3D)
        {
            foreach (KeyValuePair<Point, VoronoiCellVertex> item in verticesByPoint)
            {
