...
namespace VoronoiNS
{
  public class VoronoiCell
  {
    ...
    /** AS3Delaunay library automatically gives us this, and its useless for most things, but great when
                 ...
                 */
    //public List<Point> orderedPointsOnCircumference;
        ...
        */
         ...
         the gap */
          ...
          if (nextEdge == null)
          {
            ...
            Debug.WriteLine("Major error: was trying to close the loop of an outer Cell, but couldn't find a restart point","Error");
            break;
          }
        }
    ...
    private List<Point> _cachedGizmoOutline;

    void OnDrawGizmosSelected()
    {
    Debug.WriteLine("GIZMOS SELECTED");
     // if (_cachedGizmoOutline == null)
      {
        _cachedGizmoOutline = new List<Point>();
      ...
      Debug.WriteLine("GIZMOS SELECTED: NODES = " + _cachedGizmoOutline.Count);
      
      //Gizmos.color = new Color(Random.Range(0, 1f), Random.Range(0, 1f), Random.Range(0, 1f));
      
      //for (int i = 0; i+1< _cachedGizmoOutline.Count; i++)
      //{
      //  Point left = _cachedGizmoOutline [i];
      //  Point right = _cachedGizmoOutline [i + 1];
