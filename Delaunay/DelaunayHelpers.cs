    ...
    public static class DelaunayHelpers
    {
        public static List<LineSegment> VisibleLineSegments(List<Edge> edges)
        {
            ...
            for (int i = 0; i < edges.Count; i++)
            {
                ...
                if (edge.visible)
                {
                    Nullable<Point> p1 = edge.clippedEnds[Side.LEFT];
                    Nullable<Point> p2 = edge.clippedEnds[Side.RIGHT];
        ...
        */
        ...
        {
            Dictionary<Nullable<Point>, Node> nodes = new Dictionary<Nullable<Point>, Node>();
